...
import { A as AstroError, L as LiveContentConfigError, j as AstroUserError, U as UnknownContentCollectionError, c as createComponent, k as RenderUndefinedEntryError, u as unescapeHTML, a as renderTemplate, l as renderUniqueStylesheet, n as renderScriptElement, o as createHeadAndContent, r as renderComponent } from './astro/server_FtZYREi9.mjs';
import 'kleur/colors';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_m5sp_iG5.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://tau-os.freitaseric.com", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_D_JqdkhC.mjs').then(n => n._);
...
export { CONTENT_LAYER_TYPE as C, LIVE_CONTENT_TYPE as L, getCollection as a, defineCollection as d, getEntries as g };
